...
MESAG = str(CUSTOM_PMPERMIT) if CUSTOM_PMPERMIT else "`🔶I Am Cracxy's Userbot :` **☣HOT🔥**\n\n**Just Wait For Sometime, You Will Get a Reply...Otherwise You Will Be Blocked😬**"
...
USER_BOT_NO_WARN = ("[──▄█▀█▄─────────██ \n▄████████▄───▄▀█▄▄▄▄ \n██▀▼▼▼▼▼─▄▀──█▄▄ \n█████▄▲▲▲─▄▄▄▀───▀▄ \n██████▀▀▀▀─▀────────▀▀](tg://user?id=709535915)\n\n"
                    "`Hello, This Is` **🇮🇳Cracxy🇮🇳 Security Service.**\n"
